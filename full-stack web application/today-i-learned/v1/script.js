...
async function loadFacts() {
  const res = await fetch(
    "https://dfkwvacnmnhrohyreexy.supabase.co/rest/v1/facts",
    {
      headers: {
        apikey:
        ...
        authorization:
          "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImRma3d2YWNubW5ocm9oeXJlZXh5Iiwicm9sZSI6ImFub24iLCJpYXQiOjE2OTE0MDUxOTIsImV4cCI6MjAwNjk4MTE5Mn0.fe1Dx1LFI4fXBTdKkQmhjR0S4zBpEFLFz4d-NhFKcvE",
      },
    }
  );
